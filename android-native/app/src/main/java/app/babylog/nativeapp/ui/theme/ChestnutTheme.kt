...
object ChestnutPalette {
    ...
    val SplashBg = Color(0xFFFFF0E0)
    val SplashGradientTop = Color(0xFFFFF2E6)
    val SplashGradientBottom = Color(0xFFFFE9D6)
    val SplashText = Color(0xFFA0522D)
    ...
    val SplashBgArgb = 0xFFFFF0E0.toInt()
    val SplashGradientTopArgb = 0xFFFFF2E6.toInt()
    val SplashGradientBottomArgb = 0xFFFFE9D6.toInt()
